...
/* harmony export */   changeSquareColorEvent: () => (/* binding */ changeSquareColorEvent),
...
function setResetBtnEvent() {
  ...
  reset.addEventListener("click", _domManipulation__WEBPACK_IMPORTED_MODULE_1__.buildGameBoard);
}
...
function printPath(path, steps) {
  ...
  for (let i = 1; i < path.length - 1; i++) {
    ...
    squares.forEach((element) => {
      ...
      element.removeEventListener("click", _domManipulation__WEBPACK_IMPORTED_MODULE_1__.changeSquareColorEvent)
    });
  }
